...
public interface CommentService {
    ...
    CommentReactionCountResponse reactionComment(ReactionType reactionType, String commentId, String videoId, Account account);

    CommentReactionCountResponse unReactionComment(ReactionType reactionType, String commentId, String videoId, Account account);
